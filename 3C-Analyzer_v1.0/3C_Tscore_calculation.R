...
Tscore_calculation<-function(in_file, viewpoints, bin_type, p.level=0.01, FDR.level=0.05, RC.noise=5){
	...
	for(i in 3:ncol(bin_df) ){#2
		...
		if(nrow(min_raw_cis)>20 & min_judging){#3
			...
			single_cis<-aggregate(RC~dist, data=cis, sum)
...
R_ligation_frequency_dir="/home/yuan/data_1/4C_seq/result/ligation_frequency"
R_RC_csv_name="EnzymeBin_Viewpoints_Total_RC.csv"
R_viewpoints_csv="/home/yuan/data_1/4C_seq/result/viewpoints.csv"
R_size_bin_csv="/home/yuan/data_1/4C_seq/result/genome_size_bin.csv"
R_enzyme_bin_csv="/home/yuan/data_1/4C_seq/result/genome_enzyme_bin.csv"
R_p_level="0.01"
R_RC_noise="1"
